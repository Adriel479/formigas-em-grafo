...
public class BuscaEmLarguraFase3 extends Cena {
	...
	public void onCarregar() {
		mapa.carregarMapaDeSprite("mapaBLFase3", "/mapas/buscaEmLarguraFase3.json", "/mapas/recursos.tsx");
	...
	private void criarMapa() {
		meuMapa = mapa.getMapaDeSprite("mapaBLFase3");
	...
	private void criarBarrasDeVida() {
		...
		BarraDeEnergia barra = new BarraDeEnergia(110, 120, new BufferedImage(30, 10, BufferedImage.TYPE_3BYTE_BGR));
		...
		barra = new BarraDeEnergia(660, 270, new BufferedImage(30, 10, BufferedImage.TYPE_3BYTE_BGR));
		barra.setNivelDaBarra(100);
		barra.setExtremo(false);
		barra.criarAreaRetangular("padrao", 0, 0, 30, 10);
		mapaDeBarras.put(new Point(13, 5), barra);
		...
		barra = new BarraDeEnergia(610, 470, new BufferedImage(30, 10, BufferedImage.TYPE_3BYTE_BGR));
		barra.setNivelDaBarra(100);
		barra.setExtremo(false);
		barra.criarAreaRetangular("padrao", 0, 0, 30, 10);
		mapaDeBarras.put(new Point(12, 9), barra);
		...
		mapaDeAdjacencia.put(new Point(2, 2), new ArrayList<Point>(Arrays.asList(new Point(7, 2))));
		mapaDeAdjacencia.put(new Point(2, 5), new ArrayList<Point>(Arrays.asList(new Point(7, 5))));
		mapaDeAdjacencia.put(new Point(2, 9), new ArrayList<Point>(Arrays.asList(new Point(7, 9))));
