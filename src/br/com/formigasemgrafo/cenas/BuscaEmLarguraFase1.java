...
public class BuscaEmLarguraFase1 extends Cena {
	...
	public void onCarregar() {
		mapa.carregarMapaDeSprite("mapaBLFase1", "/mapas/buscaEmLarguraFase1.json", "/mapas/recursos.tsx");
	...
	private void criarMapa() {
		meuMapa = mapa.getMapaDeSprite("mapaBLFase1");
	...
	private void criarJogador() {
		sprite = new SpriteSheet(355, 305, imagem.getImagem("jogador"), 50, 50);
	...
	private void criarBarrasDeVida() {
		...
		barra = new BarraDeEnergia(360, 520, new BufferedImage(30, 10, BufferedImage.TYPE_3BYTE_BGR));
		barra.setNivelDaBarra(100);
		barra.setExtremo(false);
		barra.criarAreaRetangular("padrao", 0, 0, 30, 10);
		mapaDeBarras.put(new Point(7, 10), barra);
		...
		mapaDeAdjacencia.put(new Point(7, 6),
				new ArrayList<Point>(Arrays.asList(new Point(7, 2), new Point(7, 10), new Point(3, 6))));
		mapaDeAdjacencia.put(new Point(7, 2), new ArrayList<Point>(Arrays.asList(new Point(7, 6))));
		mapaDeAdjacencia.put(new Point(7, 10), new ArrayList<Point>(Arrays.asList(new Point(7, 6))));
		mapaDeAdjacencia.put(new Point(3, 6), new ArrayList<Point>(Arrays.asList(new Point(7, 6))));
	}
