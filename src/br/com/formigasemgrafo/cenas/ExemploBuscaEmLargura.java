...
public class ExemploBuscaEmLargura extends Cena {
	...
	private void animarFormiga() {
		...
		switch (ato) {
		case 1:
			barraInicial.setVisivel(false);
			barraMeio.corDaBarra = Color.YELLOW;
			break;
		case 5:
			orientacaoDaFormiga = Orientacao.ESQUERDA;
			barraMeio.setVisivel(false);
			barraEsquerda.corDaBarra = Color.yellow;
			barraDireita.corDaBarra = Color.yellow;
			break;
		case 14:
		...
		case 32:
			...
			orientacaoDaFormiga = Orientacao.ESQUERDA;
			barraEsquerda.corDaBarra = new Color(128, 190, 31);
			barraDireita.corDaBarra = new Color(128, 190, 31);
			barraMeio.corDaBarra = new Color(128, 190, 31);
			barraInicial.setNivelDaBarra(100);
			barraEsquerda.setNivelDaBarra(100);
			barraDireita.setNivelDaBarra(100);
			barraMeio.setNivelDaBarra(100);
