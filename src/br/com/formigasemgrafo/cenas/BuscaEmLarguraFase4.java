...
public class BuscaEmLarguraFase4 extends Cena {
	...
	public void onCarregar() {
		mapa.carregarMapaDeSprite("mapaBLFase4", "/mapas/buscaEmLarguraFase4.json", "/mapas/recursos.tsx");
	...
	public void onCriar() {
		...
		pontos = new Point[] { new Point(150, 200), new Point(350, 350) };
	...
	private void criarMapa() {
		meuMapa = mapa.getMapaDeSprite("mapaBLFase4");
	...
	private void criarJogador() {
		sprite = new SpriteSheet(360, 305, imagem.getImagem("jogador"), 50, 50);
	...
	private void criarBarrasDeVida() {
		...
		BarraDeEnergia barra = new BarraDeEnergia(160, 170, new BufferedImage(30, 10, BufferedImage.TYPE_3BYTE_BGR));
		barra.setNivelDaBarra(100);
		barra.setExtremo(false);
		barra.criarAreaRetangular("padrao", 0, 0, 30, 10);
		mapaDeBarras.put(new Point(3, 3), barra);

		barra = new BarraDeEnergia(360, 170, new BufferedImage(30, 10, BufferedImage.TYPE_3BYTE_BGR));
		barra.setNivelDaBarra(100);
		barra.setExtremo(false);
		barra.criarAreaRetangular("padrao", 0, 0, 30, 10);
		mapaDeBarras.put(new Point(7, 3), barra);

		barra = new BarraDeEnergia(510, 170, new BufferedImage(30, 10, BufferedImage.TYPE_3BYTE_BGR));
		barra.setNivelDaBarra(100);
		barra.setExtremo(false);
		barra.criarAreaRetangular("padrao", 0, 0, 30, 10);
		mapaDeBarras.put(new Point(10, 3), barra);
		...
		barra = new BarraDeEnergia(160, 320, new BufferedImage(30, 10, BufferedImage.TYPE_3BYTE_BGR));
		barra.setNivelDaBarra(100);
		barra.setExtremo(false);
		barra.criarAreaRetangular("padrao", 0, 0, 30, 10);
		...
		barra = new BarraDeEnergia(310, 470, new BufferedImage(30, 10, BufferedImage.TYPE_3BYTE_BGR));
		barra.setNivelDaBarra(100);
		barra.setExtremo(false);
		barra.criarAreaRetangular("padrao", 0, 0, 30, 10);
		mapaDeBarras.put(new Point(6, 9), barra);

		barra = new BarraDeEnergia(510, 470, new BufferedImage(30, 10, BufferedImage.TYPE_3BYTE_BGR));
		barra.setNivelDaBarra(100);
		barra.setExtremo(false);
		barra.criarAreaRetangular("padrao", 0, 0, 30, 10);
		mapaDeBarras.put(new Point(10, 9), barra);
		...
		barra = new BarraDeEnergia(510, 320, new BufferedImage(30, 10, BufferedImage.TYPE_3BYTE_BGR));
		barra.setNivelDaBarra(100);
		barra.setExtremo(false);
		barra.criarAreaRetangular("padrao", 0, 0, 30, 10);
		mapaDeBarras.put(new Point(10, 6), barra);
		...
		barra = new BarraDeEnergia(760, 520, new BufferedImage(30, 10, BufferedImage.TYPE_3BYTE_BGR));
		barra.setNivelDaBarra(100);
		barra.setExtremo(false);
		barra.criarAreaRetangular("padrao", 0, 0, 30, 10);
		mapaDeBarras.put(new Point(15, 10), barra);
		...
		mapaDeAdjacencia.put(new Point(3, 3), new ArrayList<Point>(Arrays.asList(new Point(7, 3), new Point(3, 6))));

		mapaDeAdjacencia.put(new Point(7, 3), new ArrayList<Point>(Arrays.asList(new Point(3, 3), new Point(10, 3))));

		mapaDeAdjacencia.put(new Point(10, 3),
				new ArrayList<Point>(Arrays.asList(new Point(7, 3), new Point(10, 6), new Point(15, 3))));

		mapaDeAdjacencia.put(new Point(15, 3), new ArrayList<Point>(Arrays.asList(new Point(10, 3), new Point(15, 6))));

		mapaDeAdjacencia.put(new Point(3, 6),
				new ArrayList<Point>(Arrays.asList(new Point(3, 3), new Point(7, 6), new Point(3, 9))));

		mapaDeAdjacencia.put(new Point(7, 6), new ArrayList<Point>(Arrays.asList(new Point(3, 6), new Point(10, 6))));

		mapaDeAdjacencia.put(new Point(10, 6), new ArrayList<Point>(
				Arrays.asList(new Point(7, 6), new Point(10, 3), new Point(10, 9), new Point(15, 6))));

		mapaDeAdjacencia.put(new Point(15, 6),
				new ArrayList<Point>(Arrays.asList(new Point(15, 3), new Point(10, 6), new Point(15, 10))));

		mapaDeAdjacencia.put(new Point(15, 10), new ArrayList<Point>(Arrays.asList(new Point(15, 6))));
		mapaDeAdjacencia.put(new Point(3, 9), new ArrayList<Point>(Arrays.asList(new Point(3, 6), new Point(6, 9))));
		mapaDeAdjacencia.put(new Point(6, 9), new ArrayList<Point>(Arrays.asList(new Point(3, 9), new Point(10, 9))));
		mapaDeAdjacencia.put(new Point(10, 9), new ArrayList<Point>(Arrays.asList(new Point(10, 6), new Point(6, 9))));
	}
