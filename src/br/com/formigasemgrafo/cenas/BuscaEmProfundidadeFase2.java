...
public class BuscaEmProfundidadeFase2 extends Cena {
	...
	public void onCarregar() {
		mapa.carregarMapaDeSprite("mapaBPFase2", "/mapas/buscaEmProfundidadeFase2.json", "/mapas/recursos.tsx");
	...
	private void criarMapa() {
		meuMapa = mapa.getMapaDeSprite("mapaBPFase2");
	...
	private void criarBarrasDeVida() {
		...
		barra = new BarraDeEnergia(160, 120, new BufferedImage(30, 10, BufferedImage.TYPE_3BYTE_BGR));
		barra.setNivelDaBarra(100);
		barra.setExtremo(true);
		barra.criarAreaRetangular("padrao", 0, 0, 30, 10);
