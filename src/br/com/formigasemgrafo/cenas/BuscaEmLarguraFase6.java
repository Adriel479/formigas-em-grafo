...
public class BuscaEmLarguraFase6 extends Cena {
	...
	public void onCarregar() {
		mapa.carregarMapaDeSprite("mapaBLFase6", "/mapas/buscaEmLarguraFase6.json", "/mapas/recursos.tsx");
	...
	public void onCriar() {
		...
		pontos = new Point[] { new Point(100, 200), new Point(350, 200) };
	...
	private void criarMapa() {
		meuMapa = mapa.getMapaDeSprite("mapaBLFase6");
	...
	private void criarJogador() {
		sprite = new SpriteSheet(310, 355, imagem.getImagem("jogador"), 50, 50);
	...
	private void criarBarrasDeVida() {
		...
		BarraDeEnergia barra = new BarraDeEnergia(110, 70, new BufferedImage(30, 10, BufferedImage.TYPE_3BYTE_BGR));
		...
		barra = new BarraDeEnergia(510, 220, new BufferedImage(30, 10, BufferedImage.TYPE_3BYTE_BGR));
		barra.setNivelDaBarra(100);
		barra.setExtremo(false);
		barra.criarAreaRetangular("padrao", 0, 0, 30, 10);
