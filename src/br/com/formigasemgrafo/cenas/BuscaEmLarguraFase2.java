...
public class BuscaEmLarguraFase2 extends Cena {
	...
	public void onCarregar() {
		mapa.carregarMapaDeSprite("mapaBLFase2", "/mapas/buscaEmLarguraFase2.json", "/mapas/recursos.tsx");
	...
	private void criarMapa() {
		meuMapa = mapa.getMapaDeSprite("mapaBLFase2");
	...
	private void criarJogador() {
		sprite = new SpriteSheet(160, 300, imagem.getImagem("jogador"), 50, 50);
	...
	private void criarBarrasDeVida() {
		...
		barra = new BarraDeEnergia(160, 170, new BufferedImage(30, 10, BufferedImage.TYPE_3BYTE_BGR));
		barra.setNivelDaBarra(100);
		barra.setExtremo(false);
		barra.criarAreaRetangular("padrao", 0, 0, 30, 10);
		mapaDeBarras.put(new Point(3, 3), barra);

		barra = new BarraDeEnergia(160, 520, new BufferedImage(30, 10, BufferedImage.TYPE_3BYTE_BGR));
		barra.setNivelDaBarra(100);
		barra.setExtremo(false);
		barra.criarAreaRetangular("padrao", 0, 0, 30, 10);
		mapaDeBarras.put(new Point(3, 10), barra);

		barra = new BarraDeEnergia(410, 120, new BufferedImage(30, 10, BufferedImage.TYPE_3BYTE_BGR));
		barra.setNivelDaBarra(100);
		barra.setExtremo(false);
		barra.criarAreaRetangular("padrao", 0, 0, 30, 10);
		mapaDeBarras.put(new Point(8, 2), barra);
		...
		barra = new BarraDeEnergia(410, 320, new BufferedImage(30, 10, BufferedImage.TYPE_3BYTE_BGR));
		barra.setNivelDaBarra(100);
		barra.setExtremo(false);
		barra.criarAreaRetangular("padrao", 0, 0, 30, 10);
		mapaDeBarras.put(new Point(8, 6), barra);

		barra = new BarraDeEnergia(660, 320, new BufferedImage(30, 10, BufferedImage.TYPE_3BYTE_BGR));
		barra.setNivelDaBarra(100);
		barra.setExtremo(false);
		barra.criarAreaRetangular("padrao", 0, 0, 30, 10);
		mapaDeBarras.put(new Point(13, 6), barra);
		...
		mapaDeAdjacencia.put(new Point(3, 3), new ArrayList<Point>(Arrays.asList(new Point(3, 6))));
		mapaDeAdjacencia.put(new Point(3, 10), new ArrayList<Point>(Arrays.asList(new Point(3, 6))));
		mapaDeAdjacencia.put(new Point(8, 10), new ArrayList<Point>(Arrays.asList(new Point(8, 6))));
		mapaDeAdjacencia.put(new Point(13, 6), new ArrayList<Point>(Arrays.asList(new Point(8, 6))));
		mapaDeAdjacencia.put(new Point(11, 2), new ArrayList<Point>(Arrays.asList(new Point(8, 2))));

		mapaDeAdjacencia.put(new Point(3, 6),
				new ArrayList<Point>(Arrays.asList(new Point(3, 3), new Point(3, 10), new Point(8, 6))));
		mapaDeAdjacencia.put(new Point(8, 6), new ArrayList<Point>(
				Arrays.asList(new Point(3, 6), new Point(8, 10), new Point(8, 2), new Point(13, 6))));
		mapaDeAdjacencia.put(new Point(8, 2), new ArrayList<Point>(Arrays.asList(new Point(8, 6), new Point(11, 2))));
